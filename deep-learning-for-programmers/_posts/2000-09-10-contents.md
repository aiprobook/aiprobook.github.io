...
#### DNNL: Tensors on the CPU (In a few days)

#### Tensor-based neural networks API (SOON)

#### cuDNN: Tensors on the GPU (SOON)

### Part 7: Convolutional networks (TBD)

#### Convolutional layers (TBD)
#### Image recognition: Fashion-MNIST (TBD)
#### 1-2 additional chapters, (TBD)
