...
#### Classification and metrics: MNIST handwritten digits recognition (JUST AROUND THE CORNER)

#### Tensors, Matrices, and ND-arrays (IN A FEW WEEKS)

#### Tensors on the CPU with DNNL (SOON)

#### Tensors on the GPU with cuDNN (SOON)
