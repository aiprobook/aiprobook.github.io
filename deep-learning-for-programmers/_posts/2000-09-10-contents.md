...
####  Recurrent layers on the CPU with DNNL ([AVAILABLE](https://www.patreon.com/deep_learning?ref=83))

####  Recurrent layers on the GPU with cuDNN ([AVAILABLE](https://www.patreon.com/deep_learning?ref=84))
